...
public class Generator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/wuage-dao/src/main/java");
...
//        gc.setEntityName("%s");
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/wuage?useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=true&serverTimezone=GMT%2B8");
...
//        // 自定义输出配置
        ...
        focList.add(new FileOutConfig("/codeTemplate/mapper.xml.vm") {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/wuage-dao/src/main/resources/mapper"
...
//
        focList.add(new FileOutConfig("/codeTemplate/service.java.vm") {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                // 自定义输出文件名 ， 如果你 Entity 设置了前后缀、此处注意 xml 的名称会跟着发生变化！！
                return projectPath + "/wuage-service/src/main/java/com.wuage.service"
        ...
        focList.add(new FileOutConfig("/codeTemplate/serviceImpl.java.vm") {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/wuage-service/src/main/java/com.wuage.service"+"/impl"
        ...
        focList.add(new FileOutConfig("/codeTemplate/controller.java.vm") {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + "/wuage-web/src/main/java/com/wuage/controller/"
